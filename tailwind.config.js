  ...
  theme: {
    extend: {
      colors: {
        ...
        'hero-bg': '#fff5e1', // Add the background color for better control
        footerBorderTop: '#B488C2'
      },
      fontFamily: {
